...
// 
// Generated using ACDS version 13.1 162 at 2014.05.14.01:16:45

`timescale 1 ps / 1 ps
module proc_RAM_ctrl #(
		parameter TCM_ADDRESS_W                  = 16,
		parameter TCM_DATA_W                     = 8,
		parameter TCM_BYTEENABLE_W               = 1,
		parameter TCM_READ_WAIT                  = 12,
		parameter TCM_WRITE_WAIT                 = 8,
		parameter TCM_SETUP_WAIT                 = 12,
		parameter TCM_DATA_HOLD                  = 0,
		parameter TCM_TURNAROUND_TIME            = 1,
		...
		input  wire [15:0] uas_address,          //   uas.address
		...
		output wire [15:0] tcm_address_out,      //      .address_out
	...
	wire  [15:0] tdt_avalon_universal_master_0_address;           // tdt:m0_uav_address -> slave_translator:uav_address
	...
	wire  [15:0] slave_translator_avalon_anti_slave_0_address;    // slave_translator:av_address -> tda:av_address
