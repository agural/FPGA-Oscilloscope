...
// 
// Generated using ACDS version 13.1 162 at 2014.05.18.00:31:19

`timescale 1 ps / 1 ps
module proc_VRAM_ctrl #(
		parameter TCM_ADDRESS_W                  = 18,
		parameter TCM_DATA_W                     = 16,
		parameter TCM_BYTEENABLE_W               = 2,
		parameter TCM_READ_WAIT                  = 3,
		parameter TCM_WRITE_WAIT                 = 3,
		parameter TCM_SETUP_WAIT                 = 1,
		parameter TCM_DATA_HOLD                  = 1,
		...
		input  wire [17:0] uas_address,          //   uas.address
		...
		input  wire        tcm_waitrequest_in,   //      .waitrequest_in
		output wire        tcm_request,          //      .request
		input  wire        tcm_grant,            //      .grant
		output wire [17:0] tcm_address_out,      //      .address_out
	...
	wire  [17:0] tdt_avalon_universal_master_0_address;            // tdt:m0_uav_address -> slave_translator:uav_address
	...
	wire         slave_translator_avalon_anti_slave_0_waitrequest; // tda:av_waitrequest -> slave_translator:av_waitrequest
	wire  [15:0] slave_translator_avalon_anti_slave_0_writedata;   // slave_translator:av_writedata -> tda:av_writedata
	wire  [17:0] slave_translator_avalon_anti_slave_0_address;     // slave_translator:av_address -> tda:av_address
	...
	altera_merlin_slave_translator #(
		...
		.av_waitrequest           (slave_translator_avalon_anti_slave_0_waitrequest), //                         .waitrequest
	...
	altera_tristate_controller_aggregator #(
		...
		.tcm0_waitrequest       (tcm_waitrequest_in),                               //                          .waitrequest_in
		...
		.tcm0_waitrequest_n     (1'b1),                                             //               (terminated)
